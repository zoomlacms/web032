<%@ page language="C#" autoeventwireup="true" inherits="App_Step2, App_Web_bktk01xb" masterpagefile="~/Common/Commenu.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <div id="tab1" class="tab-pane col-lg-6 col-md-6">
                <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="20" CssClass="table table-bordered table-striped table-hover" EnableTheming="False"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <input type="radio" name="idchk" value="<%#Eval("ID") %>" />
                            </ItemTemplate>
...
<asp:Content runat="server" ContentPlaceHolderID="Script">
    ...
    <script>
        ...
        $(function () {
            ...
            $(".allchk_l").html('<input type="radio" value="0" name="idchk" checked="checked">不使用模板');
        });
    </script>
</asp:Content>
<%@ page language="C#" autoeventwireup="true" inherits="ShopCart_InputPassengers, App_Web_euyyf5ul" enableviewstatemac="false" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
   ...
   <asp:HiddenField ID="HiddenField1"  runat="server"/>
    ...
    <div id='<%# GetId(Eval("value"))%>' style="margin:10px;">

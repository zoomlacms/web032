<%@ page language="C#" autoeventwireup="true" inherits="User_Questions_ExamDetail, App_Web_lu2t5oba" enableviewstatemac="false" masterpagefile="~/User/Empty.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        if("<%:Action%>"=="view")
        {
            ...
            for (var i = 0; i < idsArr.length; i++) {
                ...
                for (var i = 0; i < model.length; i++) {
                    //里面包含ID,如果排序更改了的话,此处需要按ID,再筛一次
                    model[i].answer=answer[i].answer;
                }
            }
        }
    });

<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_QuestionManage, App_Web_pwji0luf" enableviewstatemac="false" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<%--            <li><a href="#morePanel" data-toggle="tab">其它</a></li>--%>
        ...
        <div class="tab-content col-lg-2 col-md-2 col-xs-2 col-sm-2 padding0">
            ...
            <div class="tab-pane" id="keyPanel">
                <ul class="list-group" style="border-top:none;">
                    <li data-val="" class="list-group-item active">全部</li>
                    <asp:Repeater runat="server" ID="KeyRPT" EnableViewState="false">
                        <ItemTemplate>
                            <li data-val="<%#HttpUtility.UrlEncode(Eval("KeyWordText","")) %>" class="list-group-item"><%#Eval("KeyWordText") %></li>
                        </ItemTemplate>
                    </asp:Repeater>
                </ul>
            </div>

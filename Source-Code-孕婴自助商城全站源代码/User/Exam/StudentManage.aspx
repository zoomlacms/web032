<%@ page language="C#" autoeventwireup="true" masterpagefile="~/User/Default.master" inherits="User_Exam_StudentManage, App_Web_pwji0luf" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="container margin_t5">
    ...
    <div class="container">
        ...
        <li role="presentation" class="active" data-tabid="-1"><a href="StudentManage.aspx?cid=<%=ClassID %>&status=-1">全部</a></li>
        <li role="presentation" data-tabid="0"><a href="StudentManage.aspx?cid=<%=ClassID %>&status=0" >未审核</a></li>
        <li role="presentation" data-tabid="1"><a href="StudentManage.aspx?cid=<%=ClassID %>&status=1">已审核</a></li>
      </ul>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="学生名称">
                <ItemTemplate>
                    <%#Eval("UserName") %>
                </ItemTemplate>
            </asp:TemplateField>

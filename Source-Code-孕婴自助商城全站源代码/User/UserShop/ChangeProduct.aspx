<%@ page language="C#" autoeventwireup="true" masterpagefile="" inherits="User_UserShop_ChangeProduct, App_Web_pizcrwxl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:GridView ID="GridView1" DataKeyNames="ID" Width="100%" runat="server" AllowPaging="True" class="table table-striped table-bordered table-hover" PageSize="10" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting" EmptyDataText="暂无数据"  OnPageIndexChanging="Egv_PageIndexChanging">
						<Columns>

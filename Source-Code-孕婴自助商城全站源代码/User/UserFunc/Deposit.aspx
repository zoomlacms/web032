<%@ page language="C#" autoeventwireup="true" inherits="User_UserFunc_Deposit, App_Web_alllmufy" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<%--     <%ZoomLa.Common.function.WriteErrMsg("该页面关闭访问");%>--%>
    ...
    <%--            <li><a href="#tab2" data-toggle="tab">分红记录</a></li>--%>
            ...
            <%--                <a href="/User/Info/ConsumeDetail.aspx?SType=2" class="btn btn-primary" target="_blank">查看记录</a>--%>
                        ...
                        <tr><td>账户余额：<br />(高频交易)</td><td>
                            <table class="table table-bordered table-striped">
                                <tr><td>金额</td><td>分红额度</td><td>转入日期</td><td>分红次数</td><td>操作(满30次分红方可出金)</td></tr>
...
<%--                                               <asp:TextBox runat="server" ID="bamoney_t" CssClass="form-control text_150 num" placeholder="请输入金额"></asp:TextBox>
                        ...
                        <tr><td>
                            ...
                            <table class="table table-bordered table-striped">
                                <tr><td>金额</td><td>赠送日期</td><td>分红次数</td><td>操作(满50次分红方可出金)</td></tr>

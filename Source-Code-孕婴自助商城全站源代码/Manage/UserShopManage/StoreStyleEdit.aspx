<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StoreStyleEdit.aspx.cs" Inherits="manage_UserShopManage_StoreStyleEdit" EnableViewStateMac="false" MasterPageFile="~/Manage/I/Default.master" %>

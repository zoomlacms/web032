<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddModelField, App_Web_nwacx0ki" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<tbody id="DivColorType" style="display: none" runat="server">
	<tr>
		...
		<td>
			<asp:TextBox ID="ColorDefault" CssClass="form-control pull-left" runat="server" Style="max-width: 100px;" MaxLength="7" Columns="7" />

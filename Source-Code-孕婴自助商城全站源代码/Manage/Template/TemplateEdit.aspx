<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="Manage_I_Content_TemplateEdit, App_Web_r0b1olnt" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table width="100%" cellpadding="2" border="0" cellspacing="1" class="table table-striped table-bordered" align="center">
        ...
        <tr>
            <td align="left" style="height: 410px; min-width:380px; width: 380px; vertical-align: top;">
                <div id="Tab1_header">

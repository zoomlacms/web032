<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelCallTab, App_Web_r0b1olnt" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered" >
        <tr>
            <td style="height: 410px;min-width: 380px;width:380px;vertical-align:top;text-align:left;">
                <div id="Tab1_header">
            ...
            <td>
                ...
                <div id="Textarea">
                    <asp:TextBox TextMode="MultiLine" runat="server" CssClass="form-control" ID="textContent" Style="max-width: 100%;width:100%; height: 530px;"></asp:TextBox>
                </div>
            </td>
        </tr>
    </table>

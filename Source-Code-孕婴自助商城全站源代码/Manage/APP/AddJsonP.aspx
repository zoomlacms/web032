<%@ page language="C#" autoeventwireup="true" inherits="Manage_APP_AddJsonP, App_Web_olp3ktop" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        function LoadSingle() {
            ...
            var params = [{ name: 'Title', type: 'string', defval: '测试标题' }];
            $("#Params_Hid").val(JSON.stringify(params));
            initParamData();
            $("#Params_T").val("Title");
        }

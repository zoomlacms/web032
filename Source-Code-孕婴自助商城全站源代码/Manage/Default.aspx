<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_ubxhlfyy" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
<html>
<head>
...
<%--			<li id="menu3_12_4"><a href="javascript:;" data-url="Shop/profile/LmUserListTree.aspx"><%:lang.LF("联盟会员树状图") %></a></li>--%>
	...
	<%--		<li id="menu5_2_2"><a href="javascript:;" data-url="Exam/ScoreStatics.aspx"><%:lang.LF("成绩统计") %></a> </li>--%>
		...
		<ul class="m_left_ulin" id="menu5_7">
			...
			<li id="menu5_7_2"><a href="javascript:;" data-url="Exam/Question_Class_Manage.aspx">试题节点</a></li>

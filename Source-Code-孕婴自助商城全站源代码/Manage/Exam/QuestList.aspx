<%@ page language="C#" autoeventwireup="true" inherits="Manage_Exam_QuestList, App_Web_evyduyfg" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div id="BreadDiv" class="container-fluid mysite">
        <div class="row">
            <ol class="breadcrumb navbar-fixed-top">
                ...
                <li><a href="Papers_System_Manage.aspx">考试管理</a></li>
                <li><a href="<%:Request.RawUrl %>"><asp:Label runat="server" ID="NodeName_L"></asp:Label></a>
                    <a href='AddEnglishQuestion.aspx?NodeID=<%:NodeID %>'>[添加试题]</a></li>
            </ol>
        </div>
    </div>
    <div>

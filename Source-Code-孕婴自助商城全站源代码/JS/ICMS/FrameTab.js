...
function CheckFramesScroll() {
    ...
    //        });
    //    }
    //    $("#FrameTabs .tab-strip-wrap").addClass("tab-strip-margin");
    //    $("#FrameTabs .tab-right, #FrameTabs .tab-left").css("display", "block");
    //    return true;
    //} else {
    //    $("#FrameTabs ul:eq(0)").css("margin-left", 0);
    //    $("#FrameTabs .tab-right, #FrameTabs .tab-left").css("display", "none");
    //    $("#FrameTabs .tab-strip-wrap").removeClass("tab-strip-margin");
    //    return false;
    //}
}
///Tab滚动。
...
function resizeFrame()
{
    ...
    //var rHeight = lHeight - ($("#FrameTabs").height() || 0);
